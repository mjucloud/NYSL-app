const RulesAndPolicies = () => (
  ...
  <h3 className="h4 ">FIFA FIELD REGULATIONS</h3>
  <ol>
    <li>
      <span className="bold">DIMENSIONS.</span> FIFA Law 1 provides for flexible 
    ...
    <li>
      <span className="bold">COMPETITION FIELDS.</span> Fields used within the competition program must
    ...
    <li>
      <span className="bold">FIELDS USED BY YOUNG AGE GROUPS.</span>
      <ol type="a">
        <li>
    ...
    <li>
      <span className="bold">TEAM BENCH AREAS</span>
      <ol type="a">
  ...
  <h3 className="h4 ">NUMBER OF PLAYERS</h3>
  <ul>
    <li>
      <span className="bold">TEAM SIZE.</span> Except as noted below, team rosters shall consist of not less
    ...
    <li>
      <span className="bold">SIZE OF AGE GROUP TEAMS.</span> In order to give player's maximum
  ...
  <h3 className="h4 ">SUBSTITUTIONS</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">CONFISCATED PLAYER PASSES</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">PLAYER'S EQUIPMENT</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">MIXED TEAMS</h3>
  <ul>
    <li><span className="bold">GIRLS PLAYING ON BOYS' TEAMS.</span> Girls are 
      eligible to play on boys' teams with parent/guardian permission.
    </li>
    <li><span className="bold">TYPES OF TEAMS.</span> Teams with females only 
      are Girls Teams. All others are Boys Teams.
    </li>
  </ul>
  <h3 className="h4 ">COACHING FROM THE SIDELINES</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">GAME TERMINATION</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">CONDITIONS OF REPLAY OF GAMES</h3>
  <ul>
    <li>
  ...
  <h3 className="h4 ">REFEREE RESPONSIBILITIES</h3>
  <ul>
    <li>
