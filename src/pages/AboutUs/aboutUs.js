const AboutUs = () => (
  <div className="container">
    	<h3 className='h3 d-1 fw-bold mt-3 text-center'>Mission</h3>
			...
			<h3 className='h3 d-1 fw-bold mt-2 mb-1 text-center'>Vision</h3>
			...
			<h3 className='h3 d-1 fw-bold mt-2 mb-1 text-center'>General Information</h3>
