...
const AboutUs = () => (
  <div className="container-GenInfo">
    	...
    	<h1 className="text-center text-3xl font-bold py-8">Our Mission</h1>
			...
			<h1 className="text-center text-3xl font-bold py-8">Our Vision</h1>
			...
			<h1 className="text-center text-3xl font-bold py-8">General Information</h1>
